...
def get_args_parser():
    ...
    parser.add_argument('--ckpt_dir', action='store', type=str, help='ckpt_dir', default='checkpoints/')
    parser.add_argument('--policy_class', action='store', type=str, help='policy_class, capitalize', default='ACT')
    parser.add_argument('--task_name', action='store', type=str, help='task_name', default='sim_go_to_cube')
    parser.add_argument('--seed', action='store', type=int, help='seed', default=42)
    parser.add_argument('--num_epochs', action='store', type=int, help='num_epochs', default=100)
